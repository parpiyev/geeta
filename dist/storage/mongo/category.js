...
var CategoryStorage = /** @class */ (function () {
    function CategoryStorage() {
        this.scope = "storage.category";
    }
    CategoryStorage.prototype.find = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Category_1.default.find(query)];
                    case 1:
                        categorys = _a.sent();
    ...
    CategoryStorage.prototype.findOne = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Category_1.default.findOne(query)];
                    case 1:
                        category = _a.sent();
                        if (!category) {
    ...
    CategoryStorage.prototype.create = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Category_1.default.create(payload)];
                    case 1:
                        category = _a.sent();
                        return [2 /*return*/, category];
                    case 2:
    ...
    CategoryStorage.prototype.update = function (query, payload) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Category_1.default.findOneAndUpdate(query, payload, {
                                new: true
                            })];
                    case 1:
                        category = _a.sent();
    ...
    CategoryStorage.prototype.delete = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Category_1.default.findOneAndDelete(query)];
                    case 1:
                        category = _a.sent();
                        if (!category) {
