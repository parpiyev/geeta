...
var ProductStorage = /** @class */ (function () {
    function ProductStorage() {
        this.scope = "storage.product";
    }
    ProductStorage.prototype.find = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Product_1.default.find(query)];
                    case 1:
                        products = _a.sent();
    ...
    ProductStorage.prototype.findOne = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var product, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Product_1.default.findOne(query).populate('category_id')];
                    case 1:
                        product = _a.sent();
                        if (!product) {
    ...
    ProductStorage.prototype.create = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var product, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Product_1.default.create(payload)];
                    case 1:
                        product = _a.sent();
                        return [2 /*return*/, product];
                    case 2:
    ...
    ProductStorage.prototype.update = function (query, payload) {
        return __awaiter(this, void 0, void 0, function () {
            var product, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Product_1.default.findOneAndUpdate(query, payload, {
                                new: true
                            })];
                    case 1:
                        product = _a.sent();
    ...
    ProductStorage.prototype.delete = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var product, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Product_1.default.findOneAndDelete(query)];
                    case 1:
                        product = _a.sent();
                        if (!product) {
