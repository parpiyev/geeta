    ...
    function SampleController() {
        ...
        this.getAll = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, main_1.storage.sample.find(req.query)];
                    case 1:
                        samples = _a.sent();
                        res.status(200).json({
                            success: true,
        ...
        this.get = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, main_1.storage.sample.findById(req.params.id)];
                    case 1:
                        sample = _a.sent();
                        res.status(200).json({
                            success: true,
        ...
        this.create = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, main_1.storage.sample.create(req.body)];
                    case 1:
                        sample = _a.sent();
                        res.status(201).json({
                            success: true,
        ...
        this.update = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, main_1.storage.sample.update(req.params.id, req.body)];
                    case 1:
                        sample = _a.sent();
                        res.status(200).json({
                            success: true,
        ...
        this.delete = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, main_1.storage.sample.delete(req.params.id)];
                    case 1:
                        _a.sent();
                        res.status(204).json({
                            success: true,
