    ...
    function CategoryController() {
        ...
        this.getAll = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, main_1.storage.category.find(req.query)];
                    case 1:
                        categorys = _a.sent();
                        res.status(200).json({
                            success: true,
        ...
        this.get = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, main_1.storage.category.findOne({ _id: req.params.id })];
                    case 1:
                        category = _a.sent();
                        res.status(200).json({
                            success: true,
        ...
        this.create = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, main_1.storage.category.create(req.body)];
                    case 1:
                        category = _a.sent();
                        res.status(201).json({
                            success: true,
        ...
        this.update = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, main_1.storage.category.update({ _id: req.params.id }, req.body)];
                    case 1:
                        category = _a.sent();
                        res.status(200).json({
                            success: true,
        ...
        this.delete = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, main_1.storage.category.delete({ _id: req.params.id })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, main_1.storage.category.find(req.query)];
                    case 2:
                        categorys = _a.sent();
                        res.status(200).json({
                            success: true,
